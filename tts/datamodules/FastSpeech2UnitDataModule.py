...
from tts.datasets.FastSpeech2UnitDataset import FastSpeech2UnitDataset
from .utils import EpisodicInfiniteWrapper


class FastSpeech2DataModule(pl.LightningDataModule):
    """
    FastSpeech2UnitDataset + FastSpeech2Collate. 
    """
    ...
    def train_dataloader(self):
        ...
        self.train_loader = DataLoader(
            ...
            collate_fn=self.collate.collate_fn(sort=False, re_id=False, mode="train")
        )
    ...
    def test_dataloader(self):
        ...
        self.test_loader = DataLoader(
            ...
            batch_size=self.batch_size,
            shuffle=False,
            collate_fn=self.collate.collate_fn(sort=False, re_id=False, mode="test"),
        )
